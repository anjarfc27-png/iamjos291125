-- Migration: Editorial Data
-- Description: Insert sample editorial workflow data for testing
...
-- Insert authors
INSERT INTO authors (id, publication_id, seq, email, is_principal) VALUES
('33333333-3333-3333-3333-333333333334'::uuid, '22222222-2222-2222-2222-222222222223'::uuid, 1, 'author1@example.com', true),
('33333333-3333-3333-3333-333333333335'::uuid, '22222222-2222-2222-2222-222222222224'::uuid, 1, 'author2@example.com', true),
('33333333-3333-3333-3333-333333333336'::uuid, '22222222-2222-2222-2222-222222222225'::uuid, 1, 'author3@example.com', true),
('33333333-3333-3333-3333-333333333337'::uuid, '22222222-2222-2222-2222-222222222226'::uuid, 1, 'author4@example.com', true),
('33333333-3333-3333-3333-333333333338'::uuid, '22222222-2222-2222-2222-222222222227'::uuid, 1, 'author5@example.com', true);

-- Insert author settings
INSERT INTO author_settings (author_id, locale, setting_name, setting_value, setting_type) VALUES
('33333333-3333-3333-3333-333333333334'::uuid, 'en_US', 'givenName', 'John', 'string'),
('33333333-3333-3333-3333-333333333334'::uuid, 'en_US', 'familyName', 'Smith', 'string'),
('33333333-3333-3333-3333-333333333334'::uuid, 'en_US', 'affiliation', 'University of Technology', 'string'),
('33333333-3333-3333-3333-333333333334'::uuid, 'en_US', 'country', 'US', 'string'),
('33333333-3333-3333-3333-333333333334'::uuid, 'en_US', 'orcid', '0000-0001-2345-6789', 'string'),

('33333333-3333-3333-3333-333333333335'::uuid, 'en_US', 'givenName', 'Sarah', 'string'),
('33333333-3333-3333-3333-333333333335'::uuid, 'en_US', 'familyName', 'Johnson', 'string'),
('33333333-3333-3333-3333-333333333335'::uuid, 'en_US', 'affiliation', 'Research Institute', 'string'),
('33333333-3333-3333-3333-333333333335'::uuid, 'en_US', 'country', 'UK', 'string'),

('33333333-3333-3333-3333-333333333336'::uuid, 'en_US', 'givenName', 'Michael', 'string'),
('33333333-3333-3333-3333-333333333336'::uuid, 'en_US', 'familyName', 'Brown', 'string'),
('33333333-3333-3333-3333-333333333336'::uuid, 'en_US', 'affiliation', 'Medical Center', 'string'),
('33333333-3333-3333-3333-333333333336'::uuid, 'en_US', 'country', 'CA', 'string'),

('33333333-3333-3333-3333-333333333337'::uuid, 'en_US', 'givenName', 'Emily', 'string'),
('33333333-3333-3333-3333-333333333337'::uuid, 'en_US', 'familyName', 'Davis', 'string'),
('33333333-3333-3333-3333-333333333337'::uuid, 'en_US', 'affiliation', 'Education University', 'string'),
('33333333-3333-3333-3333-333333333337'::uuid, 'en_US', 'country', 'AU', 'string'),

('33333333-3333-3333-3333-333333333338'::uuid, 'en_US', 'givenName', 'Robert', 'string'),
('33333333-3333-3333-3333-333333333338'::uuid, 'en_US', 'familyName', 'Wilson', 'string'),
('33333333-3333-3333-3333-333333333338'::uuid, 'en_US', 'affiliation', 'Security Institute', 'string'),
('33333333-3333-3333-3333-333333333338'::uuid, 'en_US', 'country', 'DE', 'string');